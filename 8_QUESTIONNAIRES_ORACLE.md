# Dating App Compatibility Questionnaires (8 Categories)

Based on the deep research report: *The Science of Romantic Compatibility, Relationship Satisfaction, and Marriage Longevity*

## Design Principles

These questionnaires follow evidence-based design:

1. **Behavioral items over abstract self-labels** — "When I feel criticized, I tend to..." is more predictive than "I value communication"
2. **Scenario-based trade-offs** — e.g., "If your career required relocating, how would you handle it?"
3. **Stress reactions, not just ideals** — how someone behaves under pressure reveals more than what they say they value
4. **Relationship-specific perceptions** — perceived partner commitment, appreciation, and sexual satisfaction are 2–3× more predictive than individual characteristics
5. **Weighted by relationship stage** — attachment and values matter most for initial compatibility; communication, equity, and shared meaning matter most for long-term success
6. **Dealbreaker identification** — some value mismatches (children, religion, substance use) are non-negotiable and should be identified early
7. **Critical vs non-critical distinction** — contempt, avoidant attachment, and value mismatches on core issues are much more consequential than preferences about hobbies or food

## Response Format Reference

- **single** — multiple choice, choose 1
- **multi** — select all that apply
- **slider** — scale of 1–10 with labeled anchors
- **range** — numeric range
- **likert** — 5-point agreement scale (Strongly Disagree · Disagree · Neutral · Agree · Strongly Agree)

## Matching Weight Reference

- **Critical** — high-weight for matching; major mismatches drive strong match penalties
- **Standard** — normal weight; shapes "fit" gradients and conversation prompts rather than hard filters
- **Stage weighting:** early matching emphasizes Categories 1 & 3; long-term prediction emphasizes Categories 2, 7, & 8; Categories 5 & 6 screen for dealbreakers at all stages
...
### What this measures
Attachment orientation (secure vs. anxious vs. avoidant), comfort with emotional closeness, trust capacity, fear of abandonment, emotional availability, responsiveness to partner distress, and pursue–withdraw tendencies—especially under ambiguity or stress.

### Research basis
- Adult attachment patterns (secure/anxious/avoidant): **Bowlby (1969/1982); Hazan & Shaver (1987); Mikulincer & Shaver (2007)**
- Attachment injury / pursue–withdraw cycle (EFT): **Johnson (2004)**
- Stress amplifies vulnerabilities (VSA): **Karney & Bradbury (1995)**

### Questions (20)

**Q1.** When someone I'm dating takes longer than usual to reply (e.g., hours), my most likely behavior is…
- **Format:** single | **Weight:** critical
- **Options:** A) I assume they're busy and continue my day · B) I feel uneasy and check repeatedly · C) I send extra messages to get clarity · D) I pull back and match their distance · E) I feel irritated and become cold
- **Measures:** ambiguity response; anxious pursuit vs avoidant distancing

**Q2.** I feel emotionally safest with a partner who…
- **Format:** single | **Weight:** standard
- **Options:** A) communicates frequently · B) gives lots of space · C) balances closeness and independence · D) shows love through actions more than words · E) is very predictable/routine-based
- **Measures:** security cues; closeness–distance preference

**Q3.** If my partner seems upset but says "I'm fine," I typically…
- **Format:** single | **Weight:** critical
- **Options:** A) gently check in later · B) ask repeatedly in the moment · C) give space and wait to be told · D) get frustrated and disengage · E) change the topic to avoid conflict
- **Measures:** responsiveness; pursue–withdraw pattern

**Q4.** In the first 2–3 months of dating, how much clarity do you prefer about exclusivity/intentions?
...
**Q5.** If I feel hurt by something my partner did, I can tell them directly without fearing they'll leave.
- **Format:** likert | **Weight:** critical
- **Measures:** secure communication; fear of abandonment

**Q6.** When I'm stressed, I prefer my partner to…
- **Format:** multi | **Weight:** standard
- **Options:** A) listen quietly · B) reassure me verbally · C) help solve the problem · D) give physical comfort · E) give me space until I'm ready · F) distract me with something fun
...
**Q9.** If my partner needs reassurance (e.g., jealousy, insecurity), my typical reaction is…
- **Format:** single | **Weight:** critical
- **Options:** A) reassure warmly · B) reassure but feel drained · C) get defensive ("you should trust me") · D) withdraw/avoid the conversation · E) become annoyed and criticize them
- **Measures:** responsiveness; partner influence acceptance

**Q10.** I'm comfortable being affectionate and emotionally close *and* having separate interests.
- **Format:** likert | **Weight:** standard
- **Measures:** secure autonomy; healthy interdependence

**Q11.** When conflict happens, I tend to need…
- **Format:** single | **Weight:** standard
- **Options:** A) immediate discussion · B) a short break (≤30 min) · C) a longer cool-down (hours) · D) sleep on it · E) I avoid and hope it passes
- **Measures:** regulation needs; stonewall risk indicator

**Q12.** Scenario: You're excited about someone, but they're inconsistent (hot/cold). What do you usually do?
- **Format:** single | **Weight:** critical
- **Options:** A) ask directly for clarity · B) try harder to "win" consistency · C) accept it and keep it casual · D) lose interest and move on · E) feel obsessed/anxious and ruminate
- **Measures:** anxious activation; attraction to inconsistency

**Q13.** I can apologize quickly when I realize I misread a situation.
- **Format:** likert | **Weight:** standard
...
**Q16.** I'm comfortable with my partner having close friends of genders they're attracted to.
- **Format:** likert | **Weight:** standard
- **Measures:** trust; jealousy sensitivity

**Q17.** Scenario: Your partner forgets something important to you (birthday plan, big meeting). Your first reaction is…
- **Format:** single | **Weight:** standard
- **Options:** A) assume good intent and talk about it · B) feel hurt but wait to see if they notice · C) get angry and accuse them of not caring · D) withdraw and go quiet · E) make a sarcastic comment
- **Measures:** attribution style; protest behaviors

**Q18.** It's easy for me to ask for what I need without making my partner responsible for my emotions.
- **Format:** likert | **Weight:** critical
- **Measures:** secure needs expression; emotional responsibility

**Q19.** If a partner wants more closeness than I do, I typically…
- **Format:** single | **Weight:** critical
- **Options:** A) negotiate and meet in the middle · B) comply but feel trapped · C) pull away more · D) criticize them as "needy" · E) end things
- **Measures:** avoidant deactivation; contempt risk

**Q20.** In past relationships, people have described me as…
- **Format:** single | **Weight:** standard
- **Options:** A) steady/grounding · B) affectionate/intense · C) independent/private · D) hard to read · E) easily worried/jealous
- **Measures:** attachment-relevant self-pattern summary (behavioral descriptor)
...
### What this measures
How someone handles disagreement—especially Four Horsemen risk (contempt is the biggest divorce predictor), repair attempts, harsh vs soft startup, ability to de-escalate, and maintenance of the 5:1 positive-to-negative ratio.

### Research basis
- Predictors of dissolution; Four Horsemen; repair; 5:1 ratio: **Gottman & Levenson (1992); Gottman (1994); Gottman & Silver (1999)**
- VSA model: adaptive processes buffer stress: **Karney & Bradbury (1995)**

### Questions (20)

**Q1.** When I feel criticized, I most often…
- **Format:** single | **Weight:** critical
- **Options:** A) ask for specifics · B) explain my intent (without owning impact) · C) counter-criticize · D) shut down/withdraw · E) get sarcastic or mocking
- **Measures:** defensiveness/stonewalling/contempt risk

**Q2.** During conflict, I can keep my tone respectful even if I'm upset.
- **Format:** likert | **Weight:** critical
...
**Q5.** When I'm wrong, I can say "You're right—I messed up" without adding a "but…".
- **Format:** likert | **Weight:** standard
- **Measures:** accountability; defensiveness reduction

**Q6.** How often do you use humor to de-escalate (without mocking)?
- **Format:** slider | **Weight:** standard
- **Anchors:** 1 = "Never" · 10 = "Often and effectively"
...
**Q11.** I can express a complaint about behavior without attacking character.
- **Format:** likert | **Weight:** critical
- **Measures:** criticism vs complaint distinction (Gottman)

**Q12.** If my partner says they feel unheard, I'm likely to…
- **Format:** single | **Weight:** critical
- **Options:** A) summarize what I heard and ask what they need · B) apologize and ask for examples · C) explain why I'm right · D) get frustrated and end the talk · E) say they're too sensitive
- **Measures:** responsiveness; defensiveness invalidation

**Q13.** When I'm upset, I sometimes say things I don't mean to "win."
- **Format:** likert | **Weight:** critical
- **Measures:** escalation; emotional aggression risk

**Q14.** Scenario: Your partner is quiet after a fight. What do you do?
- **Format:** single | **Weight:** standard
- **Options:** A) invite reconnection gently · B) give space but set a check-in time · C) demand they talk now · D) withdraw too · E) punish with coldness
...
**Q16.** In past relationships, which patterns showed up during conflict?
...
**Q19.** Scenario: Your partner points out something you did that hurt them, and it's true. Your first response is…
- **Format:** single | **Weight:** critical
- **Options:** A) "I'm sorry—tell me more." · B) "I didn't mean it, but I hear you." · C) "You do the same thing." · D) silence/leave · E) "That's ridiculous."
- **Measures:** defensiveness vs accountability; repair potential

**Q20.** I aim for more positive than negative interactions during hard conversations.
- **Format:** slider | **Weight:** standard
- **Anchors:** 1 = "I get very negative" · 10 = "I stay mostly positive/warm"
- **Measures:** approximates 5:1 positive-to-negative orientation (Gottman)
...
### What this measures
Core worldview alignment and early dealbreakers—children, religion, politics, substance use, gender roles, money priorities, geography, relationship structure. Values show strong assortative mating (politics r = 0.58) and drive "perpetual problems" if mismatched.

### Research basis
- Values structure and assortative mating: **Schwartz (1992); Buss (1989)**
- Values predict long-term fit; relationship-specific predictors: **Joel & Eastwick (2020)**
- Money beliefs ("money scripts") and communication: **LeBaron-Black et al. (2025)**

### Questions (22)

**Q1.** Do you want children?
- **Format:** single | **Weight:** critical
...
**Q2.** If a partner couldn't have children biologically, you would…
- **Format:** single | **Weight:** critical
...
**Q3.** How important is religion/spiritual practice in your daily life?
- **Format:** slider | **Weight:** critical
- **Anchors:** 1 = "Not important" · 10 = "Central to my life"
- **Measures:** religiosity centrality; assortative mating

**Q4.** Would you date/marry someone with very different political values than you?
- **Format:** single | **Weight:** critical
...
**Q5.** Scenario: You get a dream job that requires relocating for 2–4 years. You would prefer to…
- **Format:** single | **Weight:** critical
...
**Q6.** My ideal long-term relationship structure is…
- **Format:** single | **Weight:** critical
...
**Q7.** How do you feel about traditional gender roles in household/parenting?
- **Format:** single | **Weight:** critical
...
**Q8.** What best matches your approach to money in partnership?
- **Format:** single | **Weight:** critical
...
**Q9.** In your view, "financial security" means…
- **Format:** multi | **Weight:** standard
...
**Q10.** Scenario: Your partner wants to support aging parents financially or by cohabitation. Your likely stance is…
- **Format:** single | **Weight:** critical
...
**Q11.** How important is living near family/community long-term?
- **Format:** slider | **Weight:** standard
- **Anchors:** 1 = "Not important" · 10 = "Very important"
- **Measures:** rootedness vs mobility

**Q12.** Which best describes your long-term ambition?
- **Format:** single | **Weight:** standard
...
**Q13.** Scenario: You and your partner disagree on how to spend extra income. You tend to prioritize…
- **Format:** single | **Weight:** standard
...
**Q14.** How important is marriage as a goal (not just a relationship)?
- **Format:** slider | **Weight:** critical
- **Anchors:** 1 = "Not important" · 10 = "Very important"
- **Measures:** institution orientation; commitment pathway

**Q15.** Dealbreaker check: Which would end a relationship for you?
- **Format:** multi | **Weight:** critical
...
**Q16.** How do you define "a good life" most?
- **Format:** single | **Weight:** standard
...
**Q17.** Scenario: A partner changes beliefs over time (religion/politics). You are likely to…
- **Format:** single | **Weight:** standard
...
**Q18.** How important is ethical alignment (e.g., honesty, fairness, how you treat others)?
- **Format:** slider | **Weight:** standard
- **Anchors:** 1 = "Not a big focus" · 10 = "Non-negotiable"
- **Measures:** moral values importance

**Q19.** Scenario: Parenting philosophy — If you had kids, you'd lean toward…
- **Format:** single | **Weight:** critical
...
**Q20.** How important is sexual exclusivity to you?
- **Format:** slider | **Weight:** critical
- **Anchors:** 1 = "Not important" · 10 = "Essential"
- **Measures:** exclusivity value (ties to relationship model)

**Q21.** What is your preferred pace for building a life together (cohabitation/merging routines)?
- **Format:** single | **Weight:** standard
...
**Q22.** When values conflict, I prefer to…
- **Format:** single | **Weight:** standard
...
### Research basis
- Big Five and satisfaction; neuroticism (r ≈ −0.24): **Malouff et al. (2010); O'Meara & South (2019); Bach et al. (2024)**
- Vulnerability × stress × adaptation: **Karney & Bradbury (1995)**
...
### What this measures
Commitment as a relationship-maintenance engine: dedication, willingness to sacrifice, responses to alternatives, and future orientation. **Perceived partner commitment is the #1 predictor of satisfaction** across 43 longitudinal datasets (Joel & Eastwick, 2020).

### Research basis
- Investment model (satisfaction, alternatives, investments → commitment): **Rusbult (1980); Rusbult et al. (1998); Le & Agnew (2003)**
- Relationship-specific predictors: **Joel & Eastwick (2020)**
...
- Novel shared activities maintain passion: **Aron et al. (2000)**
- Sexual satisfaction as top predictor: **Joel & Eastwick (2020)**
...
### What this measures
Day-to-day friction risks (sleep, cleanliness, social energy, spending, health, substance use) plus perceived fairness in labor and finances. Inequity breeds resentment and is especially toxic during major stressors like parenthood—division of labor is the #1 stressor for new parents.

### Research basis
- Equity theory (perceived fairness predicts satisfaction): **Walster et al. (1978)**
- Stress amplifies daily frictions (VSA): **Karney & Bradbury (1995)**
- Parenthood increases labor massively; inequity predicts decline: **Shapiro et al. (2015)**
- Money scripts and communication: **LeBaron-Black et al. (2025)**
...
### What this measures
The "relationship glue": friendship quality, fondness/admiration, responsiveness to bids for connection ("turning toward"), appreciation expression, shared rituals and traditions, couple identity ("we-ness"), and supporting each other's dreams. Appreciation is the #2 predictor of relationship quality (Joel & Eastwick, 2020).

### Research basis
- Sound Relationship House: love maps, fondness, turning toward, shared meaning: **Gottman & Silver (1999)**
- Appreciation as #2 predictor: **Joel & Eastwick (2020)**
- Novel shared activities support closeness/passion: **Aron et al. (2000)**
...
| # | Questionnaire | Questions | Critical | Standard |
|---|---|---|---|---|
| 1 | Attachment & Emotional Security | 20 | 10 | 10 |
| 2 | Communication & Conflict Management | 20 | 10 | 10 |
| 3 | Values & Life Goals | 22 | 13 | 9 |
| 4 | Emotional Regulation & Personality | 20 | 7 | 13 |
| 5 | Commitment & Investment Orientation | 20 | 10 | 10 |
| 6 | Intimacy, Sexuality & Affection | 20 | 9 | 11 |
| 7 | Lifestyle Compatibility & Equity | 22 | 9 | 13 |
| 8 | Friendship, Appreciation & Shared Meaning | 20 | 8 | 12 |
| | **TOTAL** | **164** | **76** | **88** |
...
| Format | Count | Usage |
|---|---|---|
| single | 89 | Behavioral scenarios, multiple choice |
| likert | 42 | Agreement scales for attitudes/tendencies |
| slider | 23 | Intensity/importance ratings with anchors |
| multi | 16 | Select-all-that-apply for preferences |
| range | 6 | Numeric ranges (time, frequency) |

## Matching Implementation Notes

- **Critical items** should drive strong match penalties for major mismatches (e.g., kids, relationship structure, contempt markers, repeated stonewalling, unwillingness to repair, substance dealbreakers)
- **Standard items** should shape "fit" gradients and conversation prompts rather than hard filters
- **Stage weighting:** early matching emphasizes Categories **1 & 3**; long-term prediction emphasizes **2, 7, 8**; always screen for Category **5** commitment alignment and Category **6** dealbreakers
